...
class PaysMainWork extends StatefulWidget {

  @override
  _PaysMainWorkState createState() => _PaysMainWorkState();
}

class _PaysMainWorkState extends State<PaysMainWork> {
  ...
  printlist() {
    if (cars != null) {
      ...
      for (var i = 0; i < cars.docs.length; i++) {
        if (cars.docs[i].data()['Payment_cat'] == 'مصاريف ‏تشغيلية') {
          paymentslist.add({
            ...
            "Payment_entry_date": cars.docs[i].data()['Payment_entry_date']
                .toDate()
                .toString(),
            "Payment_modify_date": cars.docs[i].data()['Payment_modify_date']
                .toDate()
                .toString(),
      ...
      for (var i = 0; i < paymentslist.length; i++) {
        if (paymentslist[i]['Payment_id'].length==0) {
          //print(paymentslist[i]['Payment_id']);
          //print(paymentslist[i]['Payment_doc_id']);
        }
      }
     // print(paymentslist);
    //  paymentslist.sort(

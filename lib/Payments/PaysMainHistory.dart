...
class PaysMainHistory extends StatefulWidget {

  @override
  _PaysMainHistoryState createState() => _PaysMainHistoryState();
}

class _PaysMainHistoryState extends State<PaysMainHistory> {
  ...
  var paymentslist = [
    {
      ...
      "Payment_user": "Weman Dress",
"Payment_to": "Weman Dress",
      "Payment_img":
...
//title
          Positioned(
            ...
            left: MediaQuery.of(context).size.width / 6.5,//- ('Payments').length,
            right:MediaQuery.of(context).size.width /  6.5,
            child: Center(
              child: Text(
                AppLocalizations.of(context).translate('PaymentsHistory'),
              ...
              Navigator.of(context).push(
                new MaterialPageRoute(
                    builder: (BuildContext context) => new PaysDetails(
                      ...
                      Payment_user: paymentslist[index]['Payment_user'],
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () {
                                          FirebaseFirestore.instance.collection("Payments").doc().set({
                                            ...
                                            'Payment_desc': paymentslist[index]['Payment_desc'],
                                            'Payment_amt': paymentslist[index]['Payment_amt'],
                                            'Payment_to': paymentslist[index]['Payment_cat'],//contPaymentTo.text,
                                            'Payment_fav': 'false',
                                            'Payment_cat': paymentslist[index]['Payment_cat'],
                                            'Payment_entry_date':DateTime.parse(paymentslist[index]['Payment_entry_date']),// currentdate,
                                            'Payment_modify_date':DateTime.parse(paymentslist[index]['Payment_modify_date']),// currentdate,
                                            'Payment_img': 'URL',
                                            'Payment_from':paymentslist[index]['Payment_from'],

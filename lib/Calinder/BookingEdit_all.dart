...
class BookingEdit_all extends StatefulWidget {
  eventclass evn ;
  BookingEdit_all({this.evn});
//  int booking_no;
//  String cust_name;
//  String booking_desc;
//  String booking_by;
...
//        this.booking_desc});
  @override
  _BookingEdit_allState createState() => _BookingEdit_allState();
}
...
class _BookingEdit_allState extends State<BookingEdit_all> {
...
//  add  keyboard action
  ...
  void initState() {
    ...
    super.initState();
    _selectedbooking_status=widget.evn.booking_status;
    _selectedpays_from=widget.evn.booking_by;
    _date=widget.evn.booking_date;
    Booking_StartTime =widget.evn.booking_startTime;
    Booking_endTime =widget.evn.booking_endTime;
    Booking_String_start = formatDate(widget.evn.booking_startTime,
        [yyyy, '-', mm, '-', dd, ' ', hh]);
    Booking_String_End=   formatDate(widget.evn.booking_endTime,
            [yyyy, '-', mm, '-', dd, ' ', hh]);

    Booking_StartTime =widget.evn.booking_startTime;
    Booking_endTime =widget.evn.booking_endTime;

    contBookingno.text=widget.evn.booking_no.toString();
    contBookingDesc.text=widget.evn.booking_desc;
    contBookingName.text=widget.evn.cust_name;
    contBookingAmt.text=widget.evn.cust_pay.toString();
    contBookingMobile.text=widget.evn.cust_mobile;
    ...
    getDataproviders().then((results) {
      setState(() {
        // print(widget.evn.booking_max);
        //contBookingno.text = widget.evn.booking_max;
      ...
      body:  GestureDetector(
        ...
        child: Stack(
          children: <Widget>[
            ...
            //menu
            Positioned(
              top: MediaQuery.of(context).size.height / tfheght-20,
...
//                  );
            ...
            Positioned(
              ...
              child: Text(
                AppLocalizations.of(context).translate('Edit Booking'),
                                          ...
                                          child:  Material(
                                            ...
                                            height: MediaQuery.of(context).size.height / ((tfheght)+10),
                                              ...
                                              child: FlatButton(
                                                    ...
                                                    onPressed: () {
                                                      _showDatePicker(context,'Start',Booking_StartTime);
                                                    },
                                                  ),),
                                          SizedBox(
                                              height: MediaQuery.of(context).size.height / ((tfheght)+10),
                                              ...
                                              child: FlatButton(
                                                    ...
                                                    onPressed: () {
                                                      _showDatePicker(context,'End',Booking_endTime);
                                                    },
                                                  ),),
                                                ]),
                                          ),
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Material(
                                            elevation: 5.0,
                                            borderRadius: BorderRadius.circular(5.0),
                                            child: TextFormField(focusNode: _nodeText1,
                                        ...
                                        RaisedButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              _save_data(
                                                  ...
                                                  ,Booking_StartTime,Booking_endTime ,widget.evn.docs_id,_selectedbooking_status);

                                              Navigator.of(context).pushReplacement(
                                                new MaterialPageRoute(
                                                    builder: (BuildContext context) => new Booking_all()),
                                              );
...
//    });
  ...
  void _save_data(int booking_no,DateTime Booking_date, String cust_name, String cust_mobile,String booking_desc,
      ...
      double cust_pay, DateTime start,DateTime end,String selectedDoc,String booking_status) {
  ...
  void _showDatePicker(ctx,String ptime,DateTime curr_date) {
            ...
            children: [
              Container(
                ...
                child: CupertinoDatePicker(
                    ...
                    initialDateTime: widget.evn.booking_date,
                  ...
                  onPressed: () {
                    ...
                    if (ptime=='Start') {
                      if(Booking_String_start == 'Start Time') {
                        setState(() {
                          Booking_String_start=formatDate(DateTime.now(),
                              [yyyy,'-',mm,'-',dd,' ',hh]);
                          Booking_StartTime =DateTime.now();
                        });
                      ...
                      if(Booking_String_End == 'End Time') {
                        setState(() {
                          Booking_String_End=formatDate(DateTime.now(),
                              [yyyy,'-',mm,'-',dd,' ',hh]);
                          Booking_endTime =DateTime.now();
                        });

...
class NoteAdd extends StatefulWidget {
  var Docs_max;
  var Docs_max_ref;
  NoteAdd({this.Docs_max,this.Docs_max_ref});
  @override
...
//  add  keyboard action
  ...
  void initState() {
    ...
    setState(() {
      contNote_no.text = widget.Docs_max!=null  ?widget.Docs_max : (1).toString() ;
      contNote_no_ref.text = widget.Docs_max_ref!=null  ?widget.Docs_max_ref : (1).toString() ;
                                    ...
                                    Container(
                                      ...
                                      child: Material(
                                        ...
                                        Padding(
                                          ...
                                          child: Text('${AppLocalizations.of(context).translate('Entry Date')} :'),
                                        ),
                                      ),
                                    ),
                                    SizedBox(width:5),
...
//    Color otherColor = new Color(value);
    _showSnackbar(contNote_no_ref.text);
    setState(() {

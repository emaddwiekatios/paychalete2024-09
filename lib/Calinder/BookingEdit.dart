...
//  add  keyboard action
  ...
  void initState() {
    ...
    _date=widget.evn.booking_date;
    _date=widget.evn.booking_date;
    contBookingNotes.text=widget.evn.booking_notes;
    getCurrentUser();
    //  print("inside init");
    colorOne = Red_deep2;
    colorTwo = Red_deep3;
                                        ...
                                        RaisedButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              _save_data(
                                                  ...
                                                  ,Booking_StartTime,Booking_endTime ,widget.evn.docs_id,_selectedbooking_status,contBookingNotes.text);
...
//    });
  ...
  void _save_data(int booking_no,DateTime Booking_date, String cust_name, String cust_mobile,String booking_desc,
      ...
      double cust_pay, DateTime start,DateTime end,String selectedDoc,String booking_status,bookingnotes) {

...
class MainShacks_Done extends StatefulWidget {

  @override
  _MainShacks_DoneState createState() => _MainShacks_DoneState();
}

class _MainShacks_DoneState extends State<MainShacks_Done> {
  ...
  printlist() {
    if (cars != null) {
      ...
      for (var i = 0; i < cars.docs.length; i++) {
        ...
        setState(() {
          if(_shackone.Shack_come_date.isBefore(DateTime.now())) {

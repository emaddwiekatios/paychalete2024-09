...
class MainShacks extends StatefulWidget {

  @override
  _MainShacksState createState() => _MainShacksState();
}

class _MainShacksState extends State<MainShacks> {
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    ...
                                    style: TextStylesmall(pheight,Colors.amber),
                                  ),
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        children: <Widget>[
                                          ...
                                          SizedBox(width: 10.0),
                                          Text(
                                             Shackslist[index].Shack_no.toString(),
                                            style: TextStylesmall(pheight,Colors.black),
                                          ),
                                          SizedBox(width: 10.0),

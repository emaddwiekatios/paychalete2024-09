...
import 'package:paychalet/Providers/MainProviders.dart';
...
class ProviderEdit extends StatefulWidget {
  ...
  @override
  _ProviderEditState createState() => _ProviderEditState();
}
...
class _ProviderEditState extends State<ProviderEdit> {
  ...
  void initState(){
    print("inside init");
    setState(() {
      contcatid.text = widget.Provider_id;
      contcatname.text = widget.Provider_name;
      contcatremark.text=widget.Provider_remark;
      contcatdesc.text = widget.Provider_desc;
      contcatimg.text=widget.Provider_img;
      contcatentrydate.text=widget.Provider_date;
              ...
              RaisedButton(
                ...
                onPressed: () {
                  ...
                  if ( sampleimage == null )
                  {
                    ...
                    updateDataonly(widget.Provider_doc_id);
                   // Navigator.pushReplacement(context, "/ProviderList");
...
///////
  ...
  Future<String> uploadimage() async {
    ...
    updateData(widget.Provider_doc_id);
    //addimagedata();
    return "";
  ...
  addimagedata() {
    FirebaseFirestore.instance.collection("Providers").doc().setData({
      'Provider_id': contcatid.text,
      'Provider_name': contcatname.text,
      'Provider_desc': contcatdesc.text,
      'Provider_remark': contcatremark.text,
      'Provider_date':contcatentrydate.text,// contCatenterydate.text,
      'Provider_img': url2
    });
  }
  ...
  updateDataonly(selectedDoc) {
    ...
    FirebaseFirestore.instance
        ...
        .update(
        {
          ...
          'Provider_desc': contcatdesc.text,
          'Provider_remark': contcatremark.text,
          'Provider_date':currentdate// contCatenterydate.text,
          // 'Provider_img': url2
        }
    )
        .catchError((e) {

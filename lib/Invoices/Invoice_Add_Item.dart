...
class Invoice_Add_Item extends StatefulWidget {
  Types_Class SelectedType;
  Invoice_Add_Item({this.SelectedType});
  @override
  _Invoice_Add_ItemState createState() => _Invoice_Add_ItemState();
}
...
QuerySnapshot cars;
//List<Types_Class> Invoice_Add_Item= [];

class _Invoice_Add_ItemState extends State<Invoice_Add_Item> {
...
//      Invoice_Add_Item.sort(
//              (a, b) => a.id.compareTo(b.id));
//      var array_len = Invoice_Add_Item.length;
//      setState(() {
//        Type_id_max = (Invoice_Add_Item[array_len - 1].id + 1);
//        Invoice_Add_Item.sort((b, a) =>
//            a.id.compareTo(b.id));
...
*/
                      ...
                      child: Container(
                        ...
                        child: new GestureDetector(
                          child: new GestureDetector(
                            ...
                            onTap: () {
                              setState(() {
                                print('list id${list[i].id}');
                                print('list TypeUnit${list[i].TypeUnit}');
                              ;

                                widget.SelectedType=list[i];
                                Navigator.pop(context,widget.SelectedType);
                                //  selectedCard = index;
                              });
                            },
                                  ...
                                  Row(
                                    children: [
                                      Padding(
                                        ...
                                        child: Icon(Icons.date_range,color: Red_deep,),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(left: 0,top: 0),
                                        child: Text('${ list[i].TypeName}',
              ...
              /*  child: new FutureBuilder<List>(
                  future: helperglobel.Invoice_Add_Item(),
...
//                  onTap: () {
//                    setState(() {
//                      Invoice_Add_Item(SelectedType: list[i]);
//                    //  selectedCard = index;
//                    });
//                  },
//

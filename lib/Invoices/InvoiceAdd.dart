...
//    final scaff = Scaffold.of(context);
    _scaffoldKey.currentState.showSnackBar(SnackBar(
      content: Text('Invoice ${name} Saved'),
...
//                                                                      .length;
//                                                              i++) {
//                                                                print('_InvoicesubList[i].Type_Total${_InvoicesubList[i].Type_Total}');
//                                                                print('_InvoicesubList[i].Type_no${_InvoicesubList[i].Type_no}');
//                                                                print('_InvoicesubList[i].unit${_InvoicesubList[i].Type_unit}');
//                                                                Invoice _Invsubone =
//                                                                Invoice();
//                                                                _Invsubone.Type_no =
//                                                                    _InvoicesubList[i]
...
//                                                                _showSnackbar(_InvoiceList[0].Invoice_no.toString());
//                                                              });
//
//
//

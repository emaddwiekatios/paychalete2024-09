...
//import 'package:paychalet/Invoices/Invoice_Report_Type_GP_details.dart';
class Invoice_Report_Type_GP extends StatefulWidget {
  @override
  _Invoice_Report_Type_GPState createState() => _Invoice_Report_Type_GPState();
}
...
class _Invoice_Report_Type_GPState extends State<Invoice_Report_Type_GP> {
...
//print(listtype[i].Type_name);
      ...
      loc_qty = loc_qty + listtype[i].Type_qty;
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Center(child: Text('${AppLocalizations.of(context).translate('qty')}'+ ' : ${sumqty}')
                    ),
                  ),
                  Container(
                    decoration: BoxDecoration(
      ...
      RefreshIndicator(
        // key: refreshKey,
         ...
         Padding(
           ...
           child: StickyGroupedListView<dynamic, dynamic>(
             stickyHeaderBackgroundColor: Colors.amber,
             elements: listtype,

             groupBy: (dynamic element) => element.Type_name,//|element.Type_price).toString(),
             groupSeparatorBuilder: (dynamic element) => Text('    ${element.Type_name}',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                                           ...
                                           Row(
                                             children: [
                                               Padding(
                                                 ...
                                                 child: Text('Price : ${element.Type_price}',
                                                     style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                                               ),
                                               Padding(
                                                 padding: const EdgeInsets.only(right:10.0,left:10,top:5),
                                                 child: Text('Qty : ${element.Type_qty}',
                                                     style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                                               ),
                                               Padding(
                                                 padding: const EdgeInsets.only(right:10.0,left:10,top:5),
                                                 child: Text('Sum : ${element.Type_Total}',
                                                     style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                                               ),
                                             ],
                                           ),
                                                   ...
                                                   children: [
                                                     ...
                                                     Padding(
                                                       ...
                                                       child: Align( alignment: Alignment.topLeft,
                                                           ...
                                                           child: Text('Date :${formatDate(element.Invoice_date,
                                                               [yyyy,'-',M,'-',dd,' '])}',
                                                               style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400))),
                                                     ),
                                                     Padding(
                                                       padding: const EdgeInsets.only(right:10.0,left:10),
                                                       child: Text('SubTotal :${(element.Invoice_sub_total)}',
                                                           style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400))
                                                       ,
                                                     ),
                                                     Padding(
                                                       padding: const EdgeInsets.only(right:10.0,left:10),
                                                       child: Text('Total :${(element.Invoice_amt).toStringAsFixed(2)}',
                                                 ...
                                                 Column(
                                                   ...
                                                   children: [
                                                     ...
                                                     Padding(
                                                       ...
                                                       child:Center(child: Text('Invoice No :${element.Invoice_no}',
                                                         style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),)),
                                                     ),
                                                     Padding(
                                                       padding: const EdgeInsets.all(2.0),
                                                       child:Center(child: Text('No  ref:${element.Invoice_no_ref}',
                                                         style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),)),
                                                     ),
...
//                             ),
             ...
             itemComparator: (element1, element2) => element1.Type_name.compareTo(element2.Type_name), // optional
             itemScrollController: GroupedItemScrollController(),
             separator: Container(height: 20,width:pwidth,color:Colors.blue),// optional
...
//                                              Padding(
//                                                padding: const EdgeInsets.only(right:10.0,left:10,top:5),
//                                                child: Text('${listtype[index].Type_qty} * ${listtype[index].Type_price}',
//                                                    style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400)),
//                                              ),
//                                              Padding(
//                                                padding: const EdgeInsets.only(right:10.0,left:10,top:5),
//                                                child: Text('${listtype[index].Type_Total}',
//                                                    style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400)),
//                                              ),
//                                            ],
//                                          ),
...
//                                                    Padding(
//                                                      padding: const EdgeInsets.only(right:10.0,left:10),
//                                                      child: Text('SubTotal :${listtype[index].Invoice_sub_total}',
//                                                          style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400))
//                                                      ,
//                                                    ),
//                                                    Padding(
...
//                                                      ),
//                                                    );
//                                                    // Navigator.pushNamed(context, "/Invoice_Report_Type_GP_details");
//
//                                                  },
//                                                      icon:Icon(Icons.edit, color: Colors.green)),
//                                                  IconButton(onPressed: null,

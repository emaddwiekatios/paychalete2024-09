...
import 'package:paychalet/Invoices/Invoice.dart';
...
//import 'package:paychalet/Invoices/Invoice_Report_Type_Sum_details.dart';
class Invoice_Report_Type_Sum extends StatefulWidget {
  @override
  _Invoice_Report_Type_SumState createState() =>
      _Invoice_Report_Type_SumState();
}

var refreshKey = GlobalKey<RefreshIndicatorState>();

List<Type_sum> listsum1 = List<Type_sum>();
...
class _Invoice_Report_Type_SumState extends State<Invoice_Report_Type_Sum> {
  var listdisc = <String>[
    'Types',
  ];
  String listval;
  ...
  void gettypetotalprice() {
    print('inside get sum');

    List<String> array_type = [];
    print(listtype.length);
    for (int a = 0; a < listtype.length; a++) {
      array_type.add(listtype[a].Type_name.toString());
    }
    var distincttype = array_type.toSet().toList();
    double loc_sum = 0.0;
    double loc_qty = 0.0;
    double loc_price = 0.0;
    listsum1.clear();
    for (int i = 0; i < distincttype.length; i++) {
      ...
      for (int j = 0; j < listtype.length; j++) {
        if (distincttype[i] == listtype[j].Type_name) {
          loc_price=listtype[j].Type_price;
          loc_sum = loc_sum + listtype[j].Type_Total;
          loc_qty = loc_qty + listtype[j].Type_qty;
        }
      }
      Type_sum listsum1one = Type_sum();
      listsum1one.Type_name=distincttype[i];
      listsum1one.Type_total=loc_sum;
      listsum1one.Type_qty=loc_qty;
      listsum1one.Type_price=loc_price;
      setState(() {
        listsum1.add(listsum1one);
      });

    }
    print(listsum1.length);
  }
...
//     print(_invoice.Invoice_date);
    ...
    setState(() {
      list.sort((b, a) => a.Invoice_no.compareTo(b.Invoice_no));
    });
        ...
        children: <Widget>[
          ...
          Positioned(
            ...
            child: Container(
              ...
              width: 250, //MediaQuery.of(context).size.width,
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(200), color: Red_deep1),
            ),
          ),
          //menu
          Positioned(
              ...
              onPressed: () {
                ...
                Navigator.of(context).push(
                  new MaterialPageRoute(
                      builder: (BuildContext context) => new InvoiceAdd()),
                );
              },
            ),
          ),
                ...
                Container(
                  ...
                  child: Material(
                    ...
                    child: Padding(
                      ...
                      child: DropDownButtonString(listdisc, '${listdisc[0]}',
                          (String val) {
                        //print('val=${val}');
...
//                    element.Type_name, //|element.Type_price).toString(),
...
//                                                        Alignment.topLeft,
//                                                    child: Text(
//                                                        'Date :${formatDate(element.Invoice_date, [
//                                                          yyyy,
//                                                          '-',
//                                                          M,
//                                                          '-',
...
//                                                    right: 10.0, left: 10),
//                                                child: Text(
//                                                    'SubTotal :${element.Invoice_sub_total}',
//                                                    style: TextStyle(
//                                                        fontSize: 15,
//                                                        fontWeight:
//                                                            FontWeight.w400)),
...
//                                                    right: 10.0, left: 10),
//                                                child: Text(
//                                                    'Total :${(element.Invoice_amt).toStringAsFixed(2)}',
//                                                    style: TextStyle(
//                                                        fontSize: 15,
//                                                        fontWeight:
//                                                            FontWeight.bold,
...
////
////                                             child: Text('Notes :${element.Invoice_notes}',
...
//                    element1.Type_name.compareTo(
//                        element2.Type_name), // optional
//                itemScrollController: GroupedItemScrollController(),
//                separator: Container(
//                    height: 20, width: pwidth, color: Colors.blue), // optional
...
//            ),
          ...
          ListView.builder(
              ...
              itemCount: listsum1.length,
              //  gridDelegate: new SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2),
              itemBuilder: (BuildContext context, int index) {
//                print(listsum1[index].Invoice_no);
//                print(listsum1[index].Invoice_notes);
                            ...
                            Stack(
                              children: [
                                      ...
                                      child:Column(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            ...
                                            child: Text('${listsum1[index].Type_name}',
                                                style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                                          ),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceAround,
                                            children: [
                                              Column(
                                                children: [
                                                  ...
                                                  Padding(
                                                    padding: const EdgeInsets.only(right:10.0,left:10,top:5),
                                                    child: Text('${listsum1[index].Type_price}',
                                                        style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400)),
                                                  ),
                                                ],
                                              ),
                                              Column(
                                                children: [
                                                  ...
                                                  Padding(
                                                    padding: const EdgeInsets.only(right:10.0,left:10,top:5),
                                                    child: Text('${listsum1[index].Type_qty}',
                                                        style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400)),
                                                  ),
                                                ],
                                              ),
                                              Column(
                                                children: [
                                                  ...
                                                  Padding(
                                                    padding: const EdgeInsets.only(right:10.0,left:10,top:5),
                                                    child: Text('${listsum1[index].Type_total.toStringAsFixed(2)}',
                                                        style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400)),
                                                  ),
                                                ],
                                              ),
                                ...
                                Positioned(
                                  ...
                                  right: -10,
                                  child: Container(
                                    height: 50, //MediaQuery.of(context).size.height / 4,
                                ...
                                Positioned(
                                  ...
                                  left: -30,
                                  child: Container(
                                    height: 70, //MediaQuery.of(context).size.height / 4,
